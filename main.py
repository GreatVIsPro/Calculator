...
# Allows the button to click a number and another number
...
# Empties the input for another number to be inputted
def button_clear():
    e.delete(0, END)
...
plus_button = Button(root, text="+", padx=39, pady=20, command=button_add)
